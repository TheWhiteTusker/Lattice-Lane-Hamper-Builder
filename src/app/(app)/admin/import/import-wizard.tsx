...
/** The six tabs, in the order they should be loaded. */
const SHEETS = [
  ...
  return (
    <div className="space-y-4">
      <section className="card p-4">
        <h2 className="text-sm font-semibold">1. Export each tab from Google Sheets</h2>
        <p className="mt-1 text-sm text-[var(--color-muted)]">
          In the spreadsheet: File → Download → Comma-separated values, once per tab. Columns
          are read by position, so leave the layout exactly as it is — renamed headers are
          fine, reordered columns are not.
        </p>
